...
class VideoPortScan:
    '''
    Class used to scan user's hardware (using openCV Video) to make sure they have camera for testing purposes.
    '''
    ...
    def availableAndWorkingPorts() -> Tuple[list, list, bool]:
        '''static method to check all valid ports'''
    ...
    @staticmethod
    def create():
        '''Creates a Singleton obj to ensure we only  '''
